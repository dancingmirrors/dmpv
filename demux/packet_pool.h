 ...
 *
 * This function creates a new shared demux packet pool. Should be done only
 * once per dmpv context.
 *
 * @param global Pointer to the global context.
 */
void demux_packet_pool_init(struct dmpv_global *global);
 ...
 */
struct demux_packet_pool *demux_packet_pool_get(struct dmpv_global *global);
